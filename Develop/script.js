...
//displays current day and time at the top of the page
...
for (var i = 0; i < timeSlot.length; i++) {
  ...
  var input = $(
    `<input class = "col-md-9 description" id= "input${timeSlot[i][0]}"></input>`
  );
  var saveBtn = $(
    `<button class = "col-md-1 saveBtn" id ="${timeSlot[i][0]}"><i class="far fa-save"></i></button>`
  );
